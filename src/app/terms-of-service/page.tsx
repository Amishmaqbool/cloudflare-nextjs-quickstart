  ...
  return (
    <Layout isSidebarVisible={false}>
      <div className="max-w-[1000px] min-h-[calc(100vh-260px)] lg:px-[1rem] max-lg:pr-[2rem] mx-auto mt-2 max-lg:mt-4">
        ...
        <div
          className="mb-7 prose prose-strong:font-bold prose-a:text-[#059669] prose-a:font-bold prose-h3:text-[17px] prose-h3:font-medium prose-strong:text-[#666666] prose-ol:p-[0px] prose-ol:ml-4 prose-p:text-[#66666] leading-6 text-[16px] font-normal block max-w-none text-[#666666]"
